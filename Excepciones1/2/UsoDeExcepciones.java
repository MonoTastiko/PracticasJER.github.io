...
public class UsoDeExcepciones
{
        ...
        public static void lanzaExcepcion() throws Exception
        {
                ...
                {
                        System.err.println( "La excepción se manejo en el método lanzarExcepcion" );
                        throw excepcion; // vuelve a lanzara la excepción para procesarla más adelante
                        
                        //no se llegaría al código que se coloque aqu+i, la excepción se vuelve a lanzar en el bloque catch
                } // fin de catch
